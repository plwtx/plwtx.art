...
function Lab() {
  return (
    <div className="snap-y snap-mandatory scroll-smooth h-dvh overflow-scroll overflow-x-hidden">
        ...
        <div className="absolute top-0 left-0">
          ...
          <div id="Letter" className="m-9 md:m-0 md:p-9">
            <div className="flex justify-center md:justify-start">
              <img className="pointer-events-none w-16 m-3" src={Sinner} alt="Sinner is hiding" />
            </div>
            ...
            <p className="text-[0.5rem] skew-x-3 md:text-[0.95rem] md:w-[40%] font-NJPRegular my-9 p-6 md:p-9 text-justify text-len-Black bg-len-White">
              欢迎回家 \\\ به خانه خوش آمدی! obs.vr do research about different topics and will post them over here.
              Cases differ from each other. 307 of them are written with a disturbed state of mind or consciousness. 181
              is written based on crucial research. 91 of them are nightmares described by humans. 999 of them are here
              due to the the incongruiy. Many of them are not released yet. obs.vr asked them to not hurry up with
              sharing them. Therefore please be patient while they try their best to narrate them without givg too much
              informaمتحد زیر گننtionthat ce them an ry. !距离很重要
            </p>
            <br />
      ...
      <div className="snap-start relative min-h-dvh bg-len-Black overflow-hidden">
        <img
        ...
        <div className="absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 p-6">
          <a href="/">
            <img className="pointer-events-none w-10 invert border-2" src={logo} alt="WHATDELETED" />
          </a>
        </div>
      </div>
    </div>
