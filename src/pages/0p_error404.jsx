...
export default function Error404() {
  return (
    <section className="snap-y snap-mandatory scroll-smooth h-dvh overflow-scroll overflow-x-hidden">
      <div id="Error" className="snap-start relative min-h-dvh bg-len-Black">
        ...
        <div className="top-0 pt-32 sm:top-1/2 md:pt-16 xl:p-16 xl:pt-32 sm:left-0 sm:transform sm:-translate-y-1/2">
          <div className="absolute">
            <div className="">
              <img className="z-0 animate-spin-slow" loading="lazy" src={maru} alt="EroruChan" />
            </div>
          </div>
          <div className="absolute">
            <div className="">
        ...
        <div className="absolute bottom-0 p-3 sm:top-1/2 sm:right-0 md:px-9 xl:px-16 sm:transform sm:-translate-y-1/2">
          <div className="text-len-White text-left font-thin p-3 bg-black">
            ...
            <p className=" md:w-[40rem] text-[0.70rem] text-justify">
              I am sorry you cannot view this page instead you can view crying Pluwia. Oh how sad. This might be because
              i am still working on this page. Please be patient as i am just one person and still busy with finding a
              way to study abroad. <br /> <br /> They are worried about you please return to '
